...
This documents the environment setup performed for this project from `scene_graph_related_research_papers/D3G/README.md`, plus the extra dependencies required by the source imports.
